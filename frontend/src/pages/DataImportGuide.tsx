...
const SALES_COLUMNS: ColumnDefinition[] = [
  ...
  { name: 'ClientePK', type: 'texto', required: true, destination: 'cliente_pk', description: 'Código interno estable. Si la celda está vacía, se asigna SIN-CLIENTE.' },
  { name: 'Nombre Cliente', type: 'texto', required: true, destination: 'nombre_cliente', description: 'Nombre descriptivo. Si la celda está vacía, se asigna Sin nombre cliente.' },
