                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800/50">
                      ...
                      <tr className="bg-brand-blue/5 dark:bg-brand-cyan/5"><td className="px-4 py-2 font-mono text-xs font-bold text-brand-blue dark:text-brand-cyan">cobertura</td><td className="px-4 py-2 font-medium">Calculado Web</td><td className="px-4 py-2">-</td><td className="px-4 py-2">Stock disponible / Ventas últimos 60 días. No incluir en CSV.</td></tr>
                      <tr className="bg-brand-blue/5 dark:bg-brand-cyan/5"><td className="px-4 py-2 font-mono text-xs font-bold text-brand-blue dark:text-brand-cyan">abc_doble</td><td className="px-4 py-2 font-medium">Calculado Web</td><td className="px-4 py-2">-</td><td className="px-4 py-2">Matriz ABC de Ventas vs Inventario. No incluir en CSV.</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
